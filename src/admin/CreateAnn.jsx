            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4 ">
                <div >
                  ...
                  <input label="Full Name" type="text" required placeholder="John Doe" className='border-red-600 text-white outline-none p-2 border rounded-md'/>
                </div>
                <div>
                 <label className="block text-lg font-semibold text-white mb-2">Email</label>
                 <input label="Email" type="email" required placeholder="john@example.com" className='border-red-600 text-white outline-none p-2 border rounded-md'/>  
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input label="Phone" type="tel" required placeholder="+251 911 123 456" className='outline-none border p-2 rounded-md border-red-600 text-white' />
                </div>
