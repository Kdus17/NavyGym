...
export default function Overview() {
  return (
    <div className='grid grid-cols-4 gap-4 w-full h-full lg:grid-rows-3 cursor-default'>
        ...
        <div className='col-span-4 row-span-2  bg-neutral-800  border border-x-0 border-white/20 shadow-2xl flex flex-col skew-x-1  p-10 gap-6 h-fit'>
            <span className='text-white text-2xl font-bold -skew-x-1'>Recent Check-ins</span>
            {people.map((person,index)=>{
                return(
                    <div key={index} className='flex justify-between -skew-x-1'>
